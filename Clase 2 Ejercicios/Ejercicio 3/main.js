...
btnAgregar.addEventListener("click", () => {
    ...
    let rdoMasculino = document.getElementById("rdoMasculino");
    let rdoFemenino = document.getElementById("rdoFemenino");
    let sexo = "";
    ...
    if (empleado.Nombre !== "") {
        ...
        console.clear();
        console.log(fabrica.ToString());
        document.getElementById("fabrica").innerText = fabrica.ToString();
    }
});
